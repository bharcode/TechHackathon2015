...
public class ApifyDocHelper {
	...
	public static void createStyledDocumentFromApiSpec(WordprocessingMLPackage wordMLP, ApiSpec asp) throws Exception {
		...
		File imageFile = new File(System.getProperty("user.dir") + "//amex_logo.jpeg");
		...
		wordMLPackage.getMainDocumentPart().addParagraphOfText("\t" + labelContentType);
		wordMLPackage.getMainDocumentPart().addParagraphOfText("\t\t" + asp.getContentType());
		wordMLPackage.getMainDocumentPart().addParagraphOfText("");
		...
		wordMLPackage.getMainDocumentPart().addObject(getTextP(asp.getRequestPayload()));
		// wordMLPackage.getMainDocumentPart().addParagraphOfText("}");
		wordMLPackage.getMainDocumentPart().addParagraphOfText("");
	...
	private static P getTextP(String text) {
		P p = factory.createP();
		Text t = factory.createText();
		t.setValue(text);
		R run = factory.createR();
